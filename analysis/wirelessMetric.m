function [signals, waveformData, refSpikeTimes, dataSpikeTimes] = wirelessMetric(data, reference)
    ...
    compareSpikeTimes(f_mstimer, mstimer, spike_ts, refSpikeTimes, Fs, dataFirstPeak, refFirstPeak);
end

function [refSpikeTimes, dataSpikeTimes] = compareSpikeTimes(f_mstimer, mstimer, spike_ts, refSpikeTimes, Fs, dataFirstPeak, refFirstPeak)
    ...
    % The first spike time in both dataSpikeTimes and refSpikeTimes becomes negative, ignore those
    ...
    plotLinearRegression(refSpikeTimes(2:numSpikes), dataSpikeTimes(2:numSpikes), ...
                         'reference spike times (s)', 'Wireless recorded spike times (s)');
    ...
    title('Wireless rasters: refSpikeTimes, dataSpikeTimes');
    xlabel('time (s)');
